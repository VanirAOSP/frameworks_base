...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private final Runnable mScreenRecordRunnable = new Runnable() {
        ...
        public void run() {
            ...
            intent.setComponent(ComponentName.unflattenFromString(
                    "com.android.settings/com.android.settings.vanir.activities.ScreenRecordActivity"));
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mOrientationImmersiveState = Settings.System.getInt(resolver,
    ...
    public void updateRotationStateForImmersive() {
        ...
        switch (orientation) {
            case Configuration.ORIENTATION_LANDSCAPE:
                if (mOrientationImmersiveState == 1) {
                    shouldEnable = true;
                }
                if (mOrientationImmersiveState == 2) {
                    shouldEnable = false;
                }
                break;
