...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
	...
	// next: On-The-Go, if enabled
        boolean showOnTheGo = System.Settings.getBoolean(mContext.getContentResolver(),
                System.Settings.POWER_MENU_ONTHEGO_ENABLED, false);
        if (showOnTheGo) {
            mItems.add(
                new SinglePressAction(com.android.internal.R.drawable.ic_lock_onthego,
                        ...
                        public void onPress() {
                            VanirActions.processAction(mContext,
                                    VanirActions.ACTION_ONTHEGO_TOGGLE);
                        }
	...
	private void startOnTheGo() {
        final ComponentName cn = new ComponentName("com.android.systemui",
                "com.android.systemui.vanir.onthego.OnTheGoService");
