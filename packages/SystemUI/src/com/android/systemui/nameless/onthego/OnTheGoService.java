...
package com.android.systemui.vanir.onthego;
...
import com.android.internal.util.vanir.VanirUtils;
...
public class OnTheGoService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent == null || !VanirUtils.hasCamera(this)) {
            stopSelf();
    ...
    private void getCameraInstance(int type) throws RuntimeException, IOException {
        ...
        if (!VanirUtils.hasFrontCamera(this)) {
            mCamera = Camera.open();
            return;
        }
