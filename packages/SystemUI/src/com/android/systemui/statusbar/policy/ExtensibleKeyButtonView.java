...
public class ExtensibleKeyButtonView extends KeyButtonView {
    ...
    public void setVanirTarget(VanirTarget targ){
        mVanirTarget = targ;
        }
    ...
    public void setActions(String ClickAction, String Longpress) {
        ...
        if (ClickAction != null) {
            if (ClickAction.equals(VanirTarget.ACTION_HOME)) {
                setCode(KeyEvent.KEYCODE_HOME);
                setId(R.id.home);
            } else if (ClickAction.equals(VanirTarget.ACTION_BACK)) {
                setCode (KeyEvent.KEYCODE_BACK);
                setId(R.id.back);
            } else if (ClickAction.equals(VanirTarget.ACTION_MENU)) {
                setCode (KeyEvent.KEYCODE_MENU);
                setId(R.id.menu);
            } else if (ClickAction.equals(VanirTarget.ACTION_POWER)) {
                setCode(KeyEvent.KEYCODE_POWER);
            } else if (ClickAction.equals(VanirTarget.ACTION_SEARCH)) {
				setCode(KeyEvent.KEYCODE_SEARCH);
		    } else if (ClickAction.equals(VanirTarget.ACTION_RECENTS)) {
            ...
            if (Longpress != null)
                if ((!Longpress.equals(VanirTarget.ACTION_NULL)) || (getCode() != 0)) {
    ...
    private OnClickListener mClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            mVanirTarget.launchAction(mClickAction);
        }
    };
    ...
    private OnLongClickListener mLongPressListener = new OnLongClickListener() {
        ...
        public boolean onLongClick(View v) {
            return mVanirTarget.launchAction(mLongpress);
        }
    };
}
