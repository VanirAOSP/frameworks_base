        ...
        if (action.equals(WifiManager.WIFI_STATE_CHANGED_ACTION)) {
            ...
            if (mWifiConnected && !wasConnected) {
                ...
                if (info != null) {
                    ...
                    if (mNetworkNotifications > 0) {
                        boolean restoredConnection = mConnectionsList.contains(mWifiSsid);
                        if (!mInitialConnection && (mWifiSsid != oldWifiSsid)) {
                        ...
                        // Store the current and previous connections
                        if (mConnectionsList.size() == 5) {
