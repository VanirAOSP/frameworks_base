...
public class TogglesView extends LinearLayout {
	...
	public static final String STOCK_TOGGLES =	TOGGLE_DATA + TOGGLE_DELIMITER
							+ TOGGLE_LTE + TOGGLE_DELIMITER
							+ TOGGLE_GPS + TOGGLE_DELIMITER
							+ TOGGLE_TORCH + TOGGLE_DELIMITER
							+ TOGGLE_AIRPLANE + TOGGLE_DELIMITER
							+ TOGGLE_FCHARGE + TOGGLE_DELIMITER
							+ TOGGLE_SYNC;
