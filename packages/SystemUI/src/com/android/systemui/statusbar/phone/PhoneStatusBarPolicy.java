...
public class PhoneStatusBarPolicy implements Callback, RotationLockController.RotationLockControllerCallback, DataSaverController.Listener {
    ...
    public PhoneStatusBarPolicy(Context context, StatusBarIconController iconController,
        ...
        mContext.getContentResolver().registerContentObserver(
                System.getUriFor(System.SHOW_SU_INDICATOR), false, mSuIconObserver);
    ...
    private ContentObserver mSuIconObserver = new ContentObserver(null) {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            mSuIndicatorVisible = System.getInt(mContext.getContentResolver(),
                    System.SHOW_SU_INDICATOR, 1) == 1;
            updateSu();
        }
