...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private final BroadcastReceiver mGestureToggleReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            boolean toggled = (mGesturePanelView != null) && mGesturePanelView.getGesturePanelWindow();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                ...
                if (mGesturePanelView != null
                        && mGesturePanelView.getGesturePanelWindow()) mGesturePanelView.switchToClosingState();
            }
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        if (mGesturePanelView != null && mGesturePanelView.getGesturePanelWindow()) {
